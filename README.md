...
-main(): Membuat socket, bind ke port 8080, listen koneksi, menerima koneksi client via accept(), membaca perintah  
 client,mengeksekusi fungsi sesuai perintah, dan mengirim respon e client
